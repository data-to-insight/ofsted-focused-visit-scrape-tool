...
repo_path = os.environ.get('GITHUB_WORKSPACE', '/workspaces/ofsted-focused-visit-scrape-tool')
...
def process_provider_links(provider_links):
    ...
    for link in provider_links:
        ...
        for pdf_link in pdf_links:
            ...
            if 'children' in nonvisual_text and 'services' in nonvisual_text and 'focused visit' in nonvisual_text:
